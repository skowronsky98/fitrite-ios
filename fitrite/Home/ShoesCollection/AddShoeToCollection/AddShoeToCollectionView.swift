...
struct AddShoeToCollectionView: View {
    ...
    @ObservedObject var sizeIndicatorManager : AddShoeToCollectionManager
...
struct AddShoeView_Previews: PreviewProvider {
    static var previews: some View {
        AddShoeToCollectionView(sizeIndicatorManager: AddShoeToCollectionManager(shoe: ShoesList.Shoes[0]))
    }
}
